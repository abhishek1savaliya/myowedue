export const FONT_PRESETS = [
  ...
  },
  {
    key: "google-inter",
    label: "Google Inter",
    body: 'var(--font-google-inter), Inter, "Segoe UI", sans-serif',
    display: 'var(--font-google-inter), Inter, "Segoe UI", sans-serif',
    pdfFamily: "helvetica",
  },
  {
    key: "google-roboto",
    label: "Google Roboto",
    body: 'var(--font-google-roboto), Roboto, Arial, sans-serif',
    display: 'var(--font-google-roboto), Roboto, Arial, sans-serif',
    pdfFamily: "helvetica",
  },
  {
    key: "google-poppins",
    label: "Google Poppins",
    body: 'var(--font-google-poppins), Poppins, "Segoe UI", sans-serif',
    display: 'var(--font-google-poppins), Poppins, "Segoe UI", sans-serif',
    pdfFamily: "helvetica",
  },
  {
    key: "google-montserrat",
    label: "Google Montserrat",
    body: 'var(--font-google-montserrat), Montserrat, "Segoe UI", sans-serif',
    display: 'var(--font-google-montserrat), Montserrat, "Segoe UI", sans-serif',
    pdfFamily: "helvetica",
  },
  {
    key: "google-playfair",
    label: "Google Playfair",
    body: 'var(--font-google-playfair), "Playfair Display", Georgia, serif',
    display: 'var(--font-google-playfair), "Playfair Display", Georgia, serif',
    pdfFamily: "times",
  },
  {
    key: "executive",

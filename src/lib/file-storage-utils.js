/**
 * Pure file helpers — safe for `"use client"` (no Mongoose / Node-only deps).
 * Server code may import from here or from `@/lib/file-storage` (re-exports these).
 */
...
export function isPdfFile(file = {}) {
  return (
    ...
    fileExtensionFromName(file?.originalName || file?.secureUrl || "") === "pdf"
  );
}

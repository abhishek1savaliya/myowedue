...
const protectedRoutes = ["/dashboard", "/people", "/transactions", "/bin", "/reports", "/settings", "/content-editor"];
const authRoutes = ["/login", "/signup"];
const adminProtectedRoutes = ["/admin/dashboard", "/admin/team", "/admin/tickets", "/admin/content"];

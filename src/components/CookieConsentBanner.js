...
export default function CookieConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[90] px-4 pb-4 sm:px-6">
      <div className="mx-auto max-w-7xl rounded-3xl border border-zinc-200 bg-white/95 p-3 shadow-[0_18px_60px_rgba(0,0,0,0.14)] backdrop-blur sm:p-4 md:p-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid w-full grid-cols-2 gap-2 lg:w-auto lg:min-w-[320px]">
            <button
              ...
              className="inline-flex min-h-12 w-full items-center justify-center rounded-xl border border-zinc-300 px-3 py-3 text-center text-sm font-semibold text-zinc-700 transition hover:border-black hover:text-black"
            >
              Decline
            </button>
            <button
              ...
              className="inline-flex min-h-12 w-full items-center justify-center rounded-xl bg-linear-to-r from-amber-400 to-amber-500 px-3 py-3 text-center text-sm font-semibold text-white transition hover:from-amber-500 hover:to-amber-600"
            >
              Accept
            </button>
          </div>
